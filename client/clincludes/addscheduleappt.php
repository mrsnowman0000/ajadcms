...
if (isset($_POST['addschedule'])) {
    ...
    $sql = "INSERT INTO apprvd_appts(users_name, users_email, users_contact, service_name, service_type, appt_date)
VALUES ('$users_name','$users_email','$users_contact','$service_name','$service_type','$appt_date');";
