				...
				?>
					...
					<tr>
						...
						<td> <button class="btn btn-info" data-toggle="modal" data-target="#markdoneModal<?php echo $id ?>"><i class="fas fa-info-circle"></i> Details </button>
							...
							<button class="btn btn-danger" data-toggle="modal" data-target="#archiveappt<?php echo $id ?>"><i class="fa fa-trash"></i> Archive </button>
						</td>
					</tr>
					...
					<div class="modal fade" id="editAppointmentModal<?php echo $id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								<form action="clincludes/editappthistory.php" method="POST">
									<div class="modal-body">
										...
										<div class="form-group">
											<label> Date:</label>
											<input type="text" name="appt_date" id="datepickerappthis<?php echo $row['appt_id'] ?>" class="form-control" value="<?php echo $row['appt_date'] ?>" required>
										</div>

										<div class="form-group">
											<label> Appointment Type:</label>
											<input type="text" name="appt_desc" class="form-control" value="<?php echo $row['service_type'] ?>" required>
										</div>
					...
					<div class="modal fade" id="archiveappt<?php echo $id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog" role="document">
							<div class="modal-content">

								<div class="modal-header">
									<h4 class="modal-title">ADD TO ARCHIVE</h4>
									<button type="button" class="close" data-dismiss="modal" aria-label="Close">
										<span aria-hidden="true">&times;</span>
									</button>
								</div>
								<form action="clincludes/addarchive.php" method="POST">
									<div class="modal-body">
										<input type="text" name="id" class="form-control" id="id" value="<?php echo $id ?>" hidden>
										<div>
											<label> Name: <?php echo $row['users_name'] ?></label>
									...
									<div class="modal-footer">
										<button type="submit" class="btn btn-success" name="update"> YES </button>
										<button type="button" class="btn btn-btn" data-dismiss="modal">Cancel</button>
									</div>
								</form>
							</div>
...
<script>
  var today = new Date();
	$('#datepickerappthis' + <?php echo $row['appt_id'] ?>).datetimepicker({
		sideBySide: true,
